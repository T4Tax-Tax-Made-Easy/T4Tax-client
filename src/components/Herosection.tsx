...
import personImage from "../assets/ca.png"; // replace with correct image path // replace with your logo path
const App = () => {
  return (
    <div className="bg-[#ede8f5] min-h-screen flex flex-col justify-center items-center">
      <header className="absolute top-4 left-4 flex items-center gap-4"></header>

      <main className="flex flex-col-reverse lg:flex-row justify-center items-center lg:gap-20 gap-10 px-6 lg:px-24 py-10">
        {/* Left section */}
      ...
      <div className="border-t border-gray-300 py-2">
        <span className="text-sm text-gray-500">T4Tax-Tax Made Easy</span>
      </div>
    </div>
  );
};
